package com.mercadolibre.danilo_peixoto.config;
...
import static com.mercadolibre.danilo_peixoto.util.ScopeUtils.SCOPE_VALUE;
import static com.mercadolibre.danilo_peixoto.util.ScopeUtils.isLocalScope;
...
public class SpringDocConfig {
	...
	public OpenAPI customOpenAPI(@Value("${app.title}") String appName, @Value("${app.description}") String description, @Value("${app.version}") String version) {
		OpenAPI api = new OpenAPI().info(new Info().title(appName)
				...
				.contact(new Contact().name("danilo-peixoto")
